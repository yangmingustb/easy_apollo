...
UnderlayMessageType::UnderlayMessageType()
{
    ...
    m_keyBuffer = (unsigned char*)malloc(
            UnderlayMessage::getKeyMaxCdrSerializedSize() > 16
...
bool UnderlayMessageType::serialize(void* data, SerializedPayload_t* payload)
{
    ...
    eprosima::fastcdr::Cdr ser(
            ...
            eprosima::fastcdr::Cdr::DDS_CDR);  // Object that serializes the
                                               // data.
    ...
    payload->length =
            (uint32_t)
                    ser.getSerializedDataLength();  // Get the serialized length
    return true;
}

bool UnderlayMessageType::deserialize(SerializedPayload_t* payload, void* data)
{
    ...
    eprosima::fastcdr::Cdr deser(
            fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
            eprosima::fastcdr::Cdr::DDS_CDR);  // Object that deserializes the
                                               // data.
...
bool UnderlayMessageType::getKey(void* data, InstanceHandle_t* handle)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(
            ...
            UnderlayMessage::getKeyMaxCdrSerializedSize());  // Object that
                                                             // manages the raw
                                                             // buffer.
    eprosima::fastcdr::Cdr ser(
