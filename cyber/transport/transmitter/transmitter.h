...
template <typename M> class Transmitter : public Endpoint
{
public:
...
template <typename M> Transmitter<M>::~Transmitter() {}

template <typename M> bool Transmitter<M>::Transmit(const MessagePtr& msg)
{
