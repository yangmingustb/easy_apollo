...
class PlayInfoDefaultTypeInternal {
 public:
...
static void InitDefaultsscc_info_PlayInfo_record_2eproto() {
  ...
  {
    void* ptr = &::apollo::cyber::proto::_PlayInfo_default_instance_;
    new (ptr) ::apollo::cyber::proto::PlayInfo();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::cyber::proto::PlayInfo, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::cyber::proto::PlayInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
...
static bool dynamic_init_dummy_record_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_record_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
...
class PlayInfo::_Internal {
 public:
  using HasBits = decltype(std::declval<PlayInfo>()._has_bits_);
  static void set_has_ratio(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};

PlayInfo::PlayInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:apollo.cyber.proto.PlayInfo)
}
PlayInfo::PlayInfo(const PlayInfo& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ratio_ = from.ratio_;
  // @@protoc_insertion_point(copy_constructor:apollo.cyber.proto.PlayInfo)
}

void PlayInfo::SharedCtor() {
  ratio_ = PROTOBUF_LONGLONG(0);
}

PlayInfo::~PlayInfo() {
  // @@protoc_insertion_point(destructor:apollo.cyber.proto.PlayInfo)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void PlayInfo::ArenaDtor(void* object) {
  PlayInfo* _this = reinterpret_cast< PlayInfo* >(object);
  (void)_this;
}
void PlayInfo::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void PlayInfo::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const PlayInfo& PlayInfo::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PlayInfo_record_2eproto.base);
  return *internal_default_instance();
}


void PlayInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:apollo.cyber.proto.PlayInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* PlayInfo::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* PlayInfo::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:apollo.cyber.proto.PlayInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(1, this->_internal_ratio(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:apollo.cyber.proto.PlayInfo)
  return target;
}

size_t PlayInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.PlayInfo)
  size_t total_size = 0;
...
void PlayInfo::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:apollo.cyber.proto.PlayInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const PlayInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PlayInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:apollo.cyber.proto.PlayInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:apollo.cyber.proto.PlayInfo)
    MergeFrom(*source);
  }
}

void PlayInfo::MergeFrom(const PlayInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.cyber.proto.PlayInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void PlayInfo::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:apollo.cyber.proto.PlayInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:apollo.cyber.proto.PlayInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void PlayInfo::InternalSwap(PlayInfo* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
...
::PROTOBUF_NAMESPACE_ID::Metadata PlayInfo::GetMetadata() const {
  return GetMetadataStatic();
}
