...
_ROLEATTRIBUTES.fields_by_name['qos_profile'].message_type = qos__profile__pb2._QOSPROFILE
...
SocketAddr = _reflection.GeneratedProtocolMessageType('SocketAddr', (_message.Message,), {
  'DESCRIPTOR' : _SOCKETADDR,
  '__module__' : 'role_attributes_pb2'
  # @@protoc_insertion_point(class_scope:apollo.cyber.proto.SocketAddr)
  })
_sym_db.RegisterMessage(SocketAddr)

RoleAttributes = _reflection.GeneratedProtocolMessageType('RoleAttributes', (_message.Message,), {
