...
ShmMulticastLocator = _reflection.GeneratedProtocolMessageType('ShmMulticastLocator', (_message.Message,), {
  'DESCRIPTOR' : _SHMMULTICASTLOCATOR,
  '__module__' : 'transport_conf_pb2'
...
RtpsParticipantAttr = _reflection.GeneratedProtocolMessageType('RtpsParticipantAttr', (_message.Message,), {
...
CommunicationMode = _reflection.GeneratedProtocolMessageType('CommunicationMode', (_message.Message,), {
...
TransportConf = _reflection.GeneratedProtocolMessageType('TransportConf', (_message.Message,), {
