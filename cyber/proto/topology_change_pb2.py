...
_CHANGEMSG.fields_by_name['role_attr'].message_type = role__attributes__pb2._ROLEATTRIBUTES
...
ChangeMsg = _reflection.GeneratedProtocolMessageType('ChangeMsg', (_message.Message,), {
  ...
  '__module__' : 'topology_change_pb2'
