...
extern PlayInfoDefaultTypeInternal _PlayInfo_default_instance_;
class RecordInfo;
...
template<> ::apollo::cyber::proto::PlayInfo* Arena::CreateMaybeMessage<::apollo::cyber::proto::PlayInfo>(Arena*);
...
class PlayInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.cyber.proto.PlayInfo) */ {
 public:
  inline PlayInfo() : PlayInfo(nullptr) {}
  virtual ~PlayInfo();

  PlayInfo(const PlayInfo& from);
  PlayInfo(PlayInfo&& from) noexcept
    : PlayInfo() {
    *this = ::std::move(from);
  }
  ...
  inline PlayInfo& operator=(PlayInfo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static inline const PlayInfo* internal_default_instance() {
    return reinterpret_cast<const PlayInfo*>(
               &_PlayInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(PlayInfo& a, PlayInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(PlayInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(PlayInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline PlayInfo* New() const final {
    return CreateMaybeMessage<PlayInfo>(nullptr);
  }

  PlayInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<PlayInfo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(PlayInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "apollo.cyber.proto.PlayInfo";
  }
  protected:
  explicit PlayInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  public:
  void clear_ratio();
  ::PROTOBUF_NAMESPACE_ID::int64 ratio() const;
  void set_ratio(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_ratio() const;
  void _internal_set_ratio(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::int64 ratio_;
  friend struct ::TableStruct_record_2eproto;
};
// -------------------------------------------------------------------
...
// optional int64 ratio = 1;
inline bool PlayInfo::_internal_has_ratio() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool PlayInfo::has_ratio() const {
  return _internal_has_ratio();
}
inline void PlayInfo::clear_ratio() {
  ratio_ = PROTOBUF_LONGLONG(0);
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 PlayInfo::_internal_ratio() const {
  return ratio_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 PlayInfo::ratio() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.PlayInfo.ratio)
  return _internal_ratio();
}
inline void PlayInfo::_internal_set_ratio(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000001u;
  ratio_ = value;
}
inline void PlayInfo::set_ratio(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_ratio(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.PlayInfo.ratio)
}
