...
TEST(FileTest, proto_set_get_test)
{
    ...
    EXPECT_FALSE(GetProtoFromASCIIFile("not_exists_dir/message.proto",
                                       &read_message));
    EXPECT_FALSE(GetProtoFromBinaryFile("not_exists_dir/message.proto",
                                        &read_message));
    ...
    EXPECT_FALSE(
            GetProtoFromFile("not_exists_dir/message.proto", &read_message));
...
TEST(FileTest, ListSubPaths)
{
    ...
    EXPECT_EQ(root_subdirs.end(), std::find(root_subdirs.begin(),
                                            root_subdirs.end(), "impossible"));
}
