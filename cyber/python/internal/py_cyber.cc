...
PyObject *cyber_PyService_register_func(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args,
                          const_cast<char *>("OO:PyService_register_func"),
...
PyObject *cyber_PyNode_create_reader(PyObject *self, PyObject *args)
{
    ...
    PyReader *reader = reinterpret_cast<PyReader *>(
            (node->create_reader((std::string const &)channel_name,
...
PyObject *cyber_PyNode_create_client(PyObject *self, PyObject *args)
{
    ...
    PyClient *client = reinterpret_cast<PyClient *>(
            (node->create_client((std::string const &)channel_name,
                                 (std::string const &)type_name)));
    PyObject *pyobj_client =
            PyCapsule_New(client, "apollo_cyber_pyclient", nullptr);
...
PyObject *cyber_PyNode_create_service(PyObject *self, PyObject *args)
{
    ...
    PyService *service = reinterpret_cast<PyService *>(
            (node->create_service((std::string const &)channel_name,
                                  (std::string const &)type_name)));
    PyObject *pyobj_service =
            PyCapsule_New(service, "apollo_cyber_pyservice", nullptr);
    return pyobj_service;
...
PyObject *cyber_PyNode_register_message(PyObject *self, PyObject *args)
{
    ...
    int len = 0;
    if (!PyArg_ParseTuple(
                args, const_cast<char *>("Os#:cyber_PyNode_register_message"),
                &pyobj_node, &desc, &len))
    {
...
PyObject *cyber_PyChannelUtils_get_msg_type(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("s#B:cyber_PyChannelUtils_get_msg_type"),
        ...
        PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("ss#:cyber_PyChannelUtils_get_debugstring_"
                                   "by_msgtype_rawmsgdata"),
                &msgtype, &rawdata, &len))
    {
...
PyObject *cyber_PyNodeUtils_get_active_nodes(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("B:cyber_PyNodeUtils_get_active_nodes"),
                &sleep_s))
    {
...
PyObject *cyber_PyNodeUtils_get_readersofnode(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("s#B:cyber_PyNodeUtils_get_readersofnode"),
                &node_name, &len, &sleep_s))
    {
...
PyObject *cyber_PyNodeUtils_get_writersofnode(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("s#B:cyber_PyNodeUtils_get_writersofnode"),
                &node_name, &len, &sleep_s))
    {
...
PyObject *cyber_PyServiceUtils_get_service_attr(PyObject *self, PyObject *args)
{
...
static PyMethodDef _cyber_methods[] = {
        ...
        {"PyChannelUtils_get_channels_info",
         cyber_PyChannelUtils_get_channels_info, METH_VARARGS, ""},

        {"PyNodeUtils_get_active_nodes", cyber_PyNodeUtils_get_active_nodes,
         METH_VARARGS, ""},
        {"PyNodeUtils_get_node_attr", cyber_PyNodeUtils_get_node_attr,
         METH_VARARGS, ""},
        ...
        {"PyServiceUtils_get_service_attr",
         cyber_PyServiceUtils_get_service_attr, METH_VARARGS, ""},
