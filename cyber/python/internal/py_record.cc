...
PyObject *cyber_PyRecordReader_GetMessageType(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("Os:cyber_PyRecordReader_GetMessageType"),
                &pyobj_reader, &channel_name))
    {
...
PyObject *cyber_PyRecordReader_GetHeaderString(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("O:cyber_PyRecordReader_GetHeaderString"),
                &pyobj_reader))
    {
        return PYOBJECT_NULL_STRING;
    }
...
PyObject *cyber_PyRecordReader_GetChannelList(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("O:cyber_PyRecordReader_GetChannelList"),
                &pyobj_reader))
    {
        AERROR << "cyber_PyRecordReader_GetChannelList:PyArg_ParseTuple "
                  "failed!";
        Py_INCREF(Py_None);
        return Py_None;
    }
...
PyObject *cyber_PyRecordWriter_WriteChannel(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("Osss#:cyber_PyRecordWriter_WriteChannel"),
...
PyObject *cyber_PyRecordWriter_WriteMessage(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
                args,
                const_cast<char *>("Oss#Ks#:cyber_PyRecordWriter_WriteMessage"),
                                                         ...
                                                         PyObject *args)
{
    ...
    {
        AERROR << "cyber_PyRecordWriter_SetSizeOfFileSegmentation parsetuple "
                  "failed!";
        Py_RETURN_FALSE;
    }
    ...
    if (nullptr == writer)
    {
        AERROR << "cyber_PyRecordWriter_SetSizeOfFileSegmentation:writer ptr "
                  "is null!";
        Py_RETURN_FALSE;
    }
                                                             ...
                                                             PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args,
                          const_cast<char *>("OK:cyber_PyRecordWriter_"
                                             "SetIntervalOfFileSegmentation"),
                          &pyobj_rec_writer, &time_sec))
    {
        AERROR << "cyber_PyRecordWriter_SetIntervalOfFileSegmentation "
                  "parsetuple "
                  "failed!";
        Py_RETURN_FALSE;
    }
    ...
    if (nullptr == writer)
    {
        AERROR << "cyber_PyRecordWriter_SetIntervalOfFileSegmentation:writer "
                  "ptr "
                  "is null!";
        Py_RETURN_FALSE;
    }
...
PyObject *cyber_PyRecordWriter_GetMessageNumber(PyObject *self, PyObject *args)
{
    ...
    {
        AERROR << "PyRecordWriter_GetMessageNumber:PyRecordWriter_"
                  "GetMessageNumber "
                  "failed!";
        return PyLong_FromUnsignedLongLong(0);
    }
...
PyObject *cyber_PyRecordWriter_GetMessageType(PyObject *self, PyObject *args)
{
    ...
    char *channel_name = nullptr;
    if (!PyArg_ParseTuple(
                args, const_cast<char *>("Os:PyRecordWriter_GetMessageType"),
                &pyobj_rec_writer, &channel_name))
    {
...
static PyMethodDef _cyber_record_methods[] = {
        ...
        {"PyRecordReader_ReadMessage", cyber_PyRecordReader_ReadMessage,
         METH_VARARGS, ""},
        {"PyRecordReader_GetMessageNumber",
         cyber_PyRecordReader_GetMessageNumber, METH_VARARGS, ""},
        ...
        {"PyRecordWriter_GetMessageNumber",
         cyber_PyRecordWriter_GetMessageNumber, METH_VARARGS, ""},
