 ...
 */
template <typename MessageT> class ReceiverManager
{
public:
 ...
 */
template <typename MessageT> ReceiverManager<MessageT>::ReceiverManager() {}
                        ...
                        [](const std::shared_ptr<MessageT>& msg,
                           ...
                           const proto::RoleAttributes& reader_attr) {
                            ...
                            PerfEventCache::Instance()->AddTransportEvent(
                                    TransPerf::DISPATCH,
                                    reader_attr.channel_id(),
                                    msg_info.seq_num());
                            data::DataDispatcher<MessageT>::Instance()
                                    ->Dispatch(reader_attr.channel_id(), msg);
                            PerfEventCache::Instance()->AddTransportEvent(
