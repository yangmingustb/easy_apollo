...
public:
    /**
     * @brief Build a record header with customized max interval time (ns) and
     * max raw size (byte) for segment.
     *
...
private:
    ...
    static const uint64_t SEGMENT_INTERVAL_ =
            60 * 1000 * 1000 * 1000ULL;                               // 60s
