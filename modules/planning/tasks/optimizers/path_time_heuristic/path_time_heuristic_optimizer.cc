    ...
    SpeedOptimizer(config)
{
    ...
    speed_heuristic_optimizer_config_ =
            config.speed_heuristic_optimizer_config();
}

bool PathTimeHeuristicOptimizer::SearchPathTimeGraph(
        SpeedData* speed_data) const
{
    // lane change, lane keep is different config.
...
#if  debug_st_dp
    AINFO << "is lane change "
          << reference_line_info_->is_change_lane_ref_line();
    AINFO << "init point " << init_point_.DebugString();
#endif
    ...
    GriddedPathTimeGraph st_graph(
            ...
            init_point_, reference_line_info_->AdcSlBoundary());
        ...
        SpeedData* const speed_data)
{
    ...
    // dp_record_debug_info(*speed_data,
    //                      reference_line_info_->mutable_st_graph_data()
    //                              ->mutable_st_graph_debug());
...
void PathTimeHeuristicOptimizer::dp_record_debug_info(
        ...
        planning_internal::STGraphDebug* st_graph_debug)
{
    ...
    st_graph_debug->mutable_dp_speed_profile()->CopyFrom(
