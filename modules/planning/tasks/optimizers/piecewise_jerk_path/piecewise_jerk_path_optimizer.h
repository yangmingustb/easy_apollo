...
#define debug_pwj_path_optimizer (0)

struct l_bound_point
{
    double lower;
    double upper;
};

struct l_state_point
{
    double l;
    double dl;
    double ddl;
...
public:
    ...
    int update_path_reference_by_learning_base(
...
private:
     ...
     * @param is_valid_path_reference: whether using learning model output or
     * not
