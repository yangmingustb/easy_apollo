...
#define debug_traj_stitch (0)

enum class trajectory_replan_type
{
    none,
    history_traj_is_null,
    complete_manual,
    history_traj_no_point,
    disabled_by_gflag,
    current_time_smaller_than_history_traj_first_point_time,
    current_time_beyond_history_traj_end_point_time,
    previous_traj_miss_path_point,
    lateral_offset_big,
};
