        ...
        const std::string& traffic_light_overlap_id)
{
    ...
    auto traffic_light_overlap_it = std::find_if(
...
bool CheckInsidePnCJunction(const ReferenceLineInfo& reference_line_info)
{
    ...
    ADEBUG << "distance_adc_pass_intersection["
           << distance_adc_pass_intersection << "] pnc_junction_overlap["
           << pnc_junction_overlap.object_id << "] start_s["
