...
DECLARE_bool(enable_speed_lattice_search);
DECLARE_bool(enable_lane_borrow_for_blocking);
...
DECLARE_int32(trajectory_imitation_gpu);
DECLARE_int32(trajectory_imitation_cpu);

// hybrid model
DECLARE_bool(skip_path_reference_in_side_pass);
DECLARE_bool(skip_path_reference_in_change_lane);

DECLARE_bool(debug_st_graph_plot);
DECLARE_bool(debug_path);
