...
private:
    ...
    // @brief obstacles total num including perception obstacles and parking
    // space boundary
    ...
    // @brief vector storing the vertices of obstacles in counter-clock-wise
    // order
    ...
    // @brief origin point for scaling down the numeric value of the
    // optimization problem in order of x , y
