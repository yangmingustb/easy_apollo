...
private:
    /**
     * @brief When the reference line info indicates that there is no lane
     * change, use lane keeping strategy for back side vehicles.
     */
    void make_backside_obstacle_decision_in_lane_keeping(
