                                                      ...
                                                      T* g)
{
    ...
    for (int i = 0; i < horizon_; ++i)
    {
        ...
        //     x[state_index + 4] -
        //     (x[state_index] +
        //      ts_ * x[time_index] * x[state_index + 3] * cos(x[state_index +
        //      2]));
        // g[constraint_index] =
        //     x[state_index + 4] -
        ...
        //     x[state_index + 5] -
        //     (x[state_index + 1] +
        //      ts_ * x[time_index] * x[state_index + 3] * sin(x[state_index +
        //      2]));
        // g[constraint_index + 1] =
        //     x[state_index + 5] -
        ...
        //      (ts_ * xWS_(3, i) / cos(uWS_(0, i)) / cos(uWS_(0, i)) /
        //      wheelbase_)
        //      *
        ...
        //     x[state_index + 7] -
        //     ((xWS_(3, i) + ts_ * uWS_(1, i)) + (x[state_index + 3] - xWS_(3,
        //     i))
        //     +
