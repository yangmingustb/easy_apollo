...
public:
    ...
    int debugString()
    {
        AINFO << "size " << num_of_knots_;
        AINFO << "init0, s: " << x_init_[0];
        AINFO << "init1, v: " << x_init_[1];
        AINFO << "init2, acc: " << x_init_[2];
        AINFO << "delta_x: " << delta_s_;
        ...
        {
            AINFO << "lower,upper: " << dx_bounds_.at(i).first << ", "
        ...
        {
            AINFO << "lower,upper: " << ddx_bounds_.at(i).first << ", "
                  << ddx_bounds_.at(i).second;
        }

        AINFO << "dddx: **********";
        AINFO << "lower, upper: " << dddx_bound_.first << ", "
              << dddx_bound_.second;
