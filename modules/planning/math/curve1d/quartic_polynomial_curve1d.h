...
public:
    ...
    QuarticPolynomialCurve1d(const double x0, const double dx0,
    ...
    QuarticPolynomialCurve1d& FitWithEndPointFirstOrder(
            ...
            const double x1, const double dx1, const double param);
...
private:
    void ComputeCoefficients(const double x0, const double dx0,
                             const double ddx0, const double dx1,
                             const double ddx1, const double param);
