...
class ContiRadarConf PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(ContiRadarConf* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ContiRadarConf(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  void unsafe_arena_set_allocated_can_conf(
      ::apollo::drivers::conti_radar::CanConf* can_conf);
  ::apollo::drivers::conti_radar::CanConf* unsafe_arena_release_can_conf();
  ...
  void unsafe_arena_set_allocated_radar_conf(
      ::apollo::drivers::conti_radar::RadarConf* radar_conf);
  ::apollo::drivers::conti_radar::RadarConf* unsafe_arena_release_radar_conf();
...
inline void CanConf::unsafe_arena_set_allocated_can_card_parameter(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.drivers.conti_radar.CanConf.can_card_parameter)
}
...
inline void ContiRadarConf::unsafe_arena_set_allocated_can_conf(
    ::apollo::drivers::conti_radar::CanConf* can_conf) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.drivers.conti_radar.ContiRadarConf.can_conf)
}
...
inline ::apollo::drivers::conti_radar::CanConf* ContiRadarConf::unsafe_arena_release_can_conf() {
...
inline ::apollo::drivers::conti_radar::CanConf* ContiRadarConf::_internal_mutable_can_conf() {
  ...
  if (can_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::drivers::conti_radar::CanConf>(GetArena());
    can_conf_ = p;
  }
  return can_conf_;
}
...
inline void ContiRadarConf::unsafe_arena_set_allocated_radar_conf(
    ::apollo::drivers::conti_radar::RadarConf* radar_conf) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.drivers.conti_radar.ContiRadarConf.radar_conf)
}
...
inline ::apollo::drivers::conti_radar::RadarConf* ContiRadarConf::unsafe_arena_release_radar_conf() {
...
inline ::apollo::drivers::conti_radar::RadarConf* ContiRadarConf::_internal_mutable_radar_conf() {
  ...
  if (radar_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::drivers::conti_radar::RadarConf>(GetArena());
    radar_conf_ = p;
  }
  return radar_conf_;
}
...
inline const std::string& ContiRadarConf::_internal_radar_channel() const {
  return radar_channel_.Get();
}
inline void ContiRadarConf::_internal_set_radar_channel(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  radar_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ContiRadarConf::set_radar_channel(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  radar_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:apollo.drivers.conti_radar.ContiRadarConf.radar_channel)
}
inline void ContiRadarConf::set_radar_channel(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  radar_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* ContiRadarConf::_internal_mutable_radar_channel() {
  _has_bits_[0] |= 0x00000001u;
  return radar_channel_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ContiRadarConf::release_radar_channel() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return radar_channel_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ContiRadarConf::set_allocated_radar_channel(std::string* radar_channel) {
  ...
  radar_channel_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), radar_channel,
      GetArena());
