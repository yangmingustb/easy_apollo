...
MaxSteerAngle = 505  # Maximum Steering Angle
SteerRatio = 16
WindowSize = 80
...
# gflags.DEFINE_boolean('show_st_graph', True, 'Show st graph')
...
class Plotter(object):
    ...
    def __init__(self, ax1, ax2, ax3, ax4, stgraph):
        ...
        self.control_steering_wheel = 0.0
        ...
        if self.stgraph:
            ...
            with self.lock:
                ...
                if self.ax[3].title == "Heading":
                    ...
                    # self.ax[3].new_planning(relative_time, self.control_acc)
    ...
    def callback_chassis(self, data):
        ...
        self.steering_wheel = -data.steering_percentage / 100 * MaxSteerAngle 
    ...
    def callback_control(self, data):
        ...
        current_wheel = data.steering_target / 100.0 * 505
        current_acc = data.acceleration
        self.control_steering_wheel = -current_wheel
        self.control_acc = current_acc
    ...
    def callback_localization(self, data):
        ...
        with self.lock:
            ...
            self.ax[2].new_carstatus(
                cartime, self.steering_wheel, self.autodrive)
...
def main(argv):
    ...
    if not FLAGS.show_st_graph:
        ...
        item2 = Item(ax2, "Speed", "Time [sec]", "Speed [m/s]", -1, 20)

        ax3 = plt.subplot(2, 2, 3, sharex=ax2)
        # item3 = Item(ax3, "Curvature", "Time [sec]", "Curvature [m-1]", -0.2,
        #              0.2)
        item3 = Item(ax3, "steering_wheel", "Time [sec]", "degree ", -510.0,
                     510)
    ...
    if not FLAGS.show_st_graph:
        ...
        control_sub.create_reader("/apollo/control",
                            control_cmd_pb2.ControlCommand, plotter.callback_control)
