...
def plot_result(routing_result, central_curve_dict):
    ...
    # plt.close()
    plt.figure()
    for RoadSegment in routing_result.road:
        plot_road(RoadSegment)
...
if __name__ == '__main__':
    ...
    # topo_graph_file = "./data/apollo_virutal_map/routing_map.bin"
    topo_graph_file = "./data/shuiku_double_direction/routing_map.bin"
    ...
    #             sys.exit(0)
    #         elif argv[0] == 'p':
    routing_result_file = "./data/log/routing_res.bin"
