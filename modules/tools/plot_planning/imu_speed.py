...
class ImuSpeed:
    ...
    def add(self, location_est):
        ...
        if self.is_lateral:
            speed = -1 * location_est.pose.linear_velocity.x * math.sin(location_est.pose.heading) + location_est.pose.linear_velocity.y * math.cos(location_est.pose.heading)
        else:
            speed = location_est.pose.linear_velocity.x * math.cos(location_est.pose.heading) + location_est.pose.linear_velocity.y *  math.sin(location_est.pose.heading)
