...
void displayStatus(const cdl::np2d::RayCastResult &result)
{
    std::string flag;
...
// penetration
TEST(BRUTE_FORCE_RAYCAST, penetration1)
{
...
// point-contact
TEST(BRUTE_FORCE_RAYCAST, point_contact)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(0.0, 0.0));
    vertices.push_back(Vector2r(5.0, 0.0));
...
// seperation
TEST(BRUTE_FORCE_RAYCAST, seperation)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(0.0, 0.0));
    vertices.push_back(Vector2r(5.0, 0.0));
...
// line_contact
TEST(BRUTE_FORCE_RAYCAST, line_contact)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(0.0, 0.0));
    vertices.push_back(Vector2r(5.0, 0.0));
    ...
    // set input
    cdl::np2d::RayCastRequest input;
    input.source = cdl::Vector2r(-10, 0);
    input.direction = cdl::Vector2r(1, 0);
    input.max_lambda = 30;
    input.shape.vertices = &vertices;
...
// seperation2
TEST(BRUTE_FORCE_RAYCAST, seperation2)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(0.0, 0.0));
    vertices.push_back(Vector2r(5.0, 0.0));
...
// seperation2
TEST(BRUTE_FORCE_RAYCAST, seperation3)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(0.0, 0.0));
    vertices.push_back(Vector2r(5.0, 1.0));
    vertices.push_back(Vector2r(5.0, 6.0));
    vertices.push_back(Vector2r(0.0, 5.0));
...
TEST(BRUTE_FORCE_RAYCAST, seperation4)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(0.0, 0.0));
    vertices.push_back(Vector2r(5.0, -0.5));
    vertices.push_back(Vector2r(5.0, 4.0));
    vertices.push_back(Vector2r(0.0, 5.0));
...
// penetration2
TEST(BRUTE_FORCE_RAYCAST, penetration2)
{
    std::vector<cdl::PointType> vertices;
...
// penetration2
TEST(BRUTE_FORCE_RAYCAST, inside1)
{
    std::vector<cdl::PointType> vertices;
    vertices.push_back(Vector2r(2.0, 0.0));
    vertices.push_back(Vector2r(5.0, 1.0));
