...
public:
     ...
     *        If the line segment is within the polygon, or it has intersect
     * with the polygon, return 0. Otherwise, this distance is the minimal
     * distance between the distances from the two ends of the line segment to
     * the polygon.
     ...
     *        If the other polygon is within this polygon, or it has overlap
     * with this polygon, return 0. Otherwise, this distance is the minimal
     * distance among the distances from the edges of the other polygon to this
     * polygon.
     ...
     * @param point The point to compute whose square of distance to the
     * polygon.
    ...
    /**
     * @brief Get all overlapped line segments of a line segment and this
     * polygon. There are possibly multiple overlapped line segments if this
    ...
    /**
     * @brief Compute intersection over union ratio of this polygon and the
     * other polygon. Note: this function only works for computing overlap
