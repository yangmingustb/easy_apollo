...
DEFINE_string(chassis_drive_mode_topic, "/apollo/canbus/chassis_drive_mode",
              "chassis drive mode topic name");

DEFINE_string(debug_planning_msg, "/apollo/cyber/debug_mode",
              "chassis debug mode topic name");
...
DEFINE_string(hmi_obstacle_topic, "/apollo/hmi/obstacles",
              "hmi obstacle topic name");
