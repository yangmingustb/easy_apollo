...
public:
     ...
     * The code will crash if \p config_file does not exist or \p config_file
     * has invalid format.
     ...
     *  </pre>
     *
     *  In the above figure, The four corner points of the vehicle is A, B, C,
     * and D. XO is VehicleParam.min_turn_radius(), X to AD is
     * left_edge_to_center, X to AB is VehicleParam.front_edge_to_center(). Then
