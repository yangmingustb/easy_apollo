...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Crosswalk_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_Crosswalk_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto = {
  false, false, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto, "modules/map/proto/map_crosswalk.proto", 244,
...
static bool dynamic_init_dummy_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto)), true);
namespace apollo {
namespace hdmap {
...
Crosswalk::Crosswalk(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:apollo.hdmap.Crosswalk)
}
...
void Crosswalk::ArenaDtor(void* object) {
  Crosswalk* _this = reinterpret_cast< Crosswalk* >(object);
  (void)_this;
}
void Crosswalk::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* Crosswalk::_InternalSerialize(
...
void Crosswalk::InternalSwap(Crosswalk* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Crosswalk, polygon_)
      + sizeof(Crosswalk::polygon_)
      - PROTOBUF_FIELD_OFFSET(Crosswalk, id_)>(
...
template<> PROTOBUF_NOINLINE ::apollo::hdmap::Crosswalk* Arena::CreateMaybeMessage< ::apollo::hdmap::Crosswalk >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::hdmap::Crosswalk >(arena);
}
