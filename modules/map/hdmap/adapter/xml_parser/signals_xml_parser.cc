        ...
        std::vector<TrafficLightInternal>* traffic_lights)
{
    ...
    while (signal_node)
    {
        ...
        int checker = UtilXmlParser::QueryStringAttribute(*signal_node, "type",
                                                          &object_type);
        checker += UtilXmlParser::QueryStringAttribute(*signal_node, "id",
                                                       &object_id);
        ...
        if (object_type == "trafficLight")
        {
            ...
            if (sign_infos_node != nullptr)
            {
                ...
                while (sign_info_node != nullptr)
                {
                    ...
                    sign_info_node =
                            sign_info_node->NextSiblingElement("signInfo");
                }
            }
            ...
            while (sub_node)
            {
                ...
                checker = UtilXmlParser::QueryStringAttribute(
                        *sub_node, "type", &sub_signal_xml_type);
