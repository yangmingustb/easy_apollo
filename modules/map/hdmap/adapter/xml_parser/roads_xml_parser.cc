                             ...
                             std::vector<RoadInternal>* roads)
{
    ...
    while (road_node)
    {
        ...
        int checker =
                UtilXmlParser::QueryStringAttribute(*road_node, "id", &id);
        ...
        std::string type;
        checker =
                UtilXmlParser::QueryStringAttribute(*road_node, "type", &type);
        if (checker != tinyxml2::XML_SUCCESS)
        {
                                        ...
                                        RoadInternal* road_info)
{
    ...
    if (sub_node != nullptr)
    {
        ...
        ObjectsXmlParser::ParseParkingSpaces(*sub_node,
                                             &road_info->parking_spaces);
        // pnc_junctions
        ObjectsXmlParser::ParsePNCJunctions(*sub_node,
                                            &road_info->pnc_junctions);
    }
}
