...
int main(int argc, char *argv[])
{
    ...
    if (!apollo::cyber::common::GetProtoFromBinaryFile(map_filename, &pb_map))
    {
    ...
    const std::string output_txt_file = FLAGS_map_dir + "/base_map.txt";
    if (!apollo::cyber::common::SetProtoToASCIIFile(pb_map, output_txt_file))
    {
    ...
    pb_map.Clear();
    ACHECK(apollo::cyber::common::GetProtoFromASCIIFile(output_txt_file, &pb_map))
