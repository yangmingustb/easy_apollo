...
public:
    ...
    /**
     * state adaptive gain, desired adaptive gain and nonlinear-component
     * adaptive gain
    ...
    /**
     * @brief execute the reference state interation with respect to the
     designed inputs in discrete-time form, with the bilinear transform
     (trapezoidal integration) method
     */
    void UpdateReference();

    /**
     * @brief execute the adaption interation with respect to the designed law
     in discrete-time form, with the bilinear transform (trapezoidal
     integration) method
    ...
    /**
     * @brief calculate the anti-windup compensation with respect to the
    ...
    /**
     * @brief set initial values for state components in reference model
     * dynamics
    ...
    /**
     * @brief set initial values for state components in actual actuator
     * dynamics
    ...
    /**
     * @brief set convergence ratio for nonlinear components in adaptive
     * dynamics
     * @param ratio_nonlinear convergence ratio for additional nonlinear
     * adaption
     */
    ...
    /**
     * @brief get convergence ratio for nonlinear components in adaptive
     * dynamics
...
protected:
    ...
    Eigen::MatrixXd
            gain_nonlinear_clamping_;  // To clamp the nonlinear adaption
    ...
    Eigen::MatrixXd
            gain_nonlinear_adaption_init_;  // Initial nonlinear adaption
