...
public:
    ...
    bool VectornetProcessObstaclePosition(
            ...
            torch::Tensor* ptr_vector_mask, torch::Tensor* ptr_all_obstacle_pos,
            torch::Tensor* ptr_all_obs_p_id, torch::Tensor* ptr_obs_length);
    ...
    bool VectornetProcessMapData(FeatureVector* map_feature,
                                 PidVector* map_p_id, const int obs_num,
